...
### 3. Language Test
If you have to relocate to take up a certain position you should expect a language test. This refers to answering a number of questions in the respective language. These tests are aimed at confirming that you have basic working knowledge. Also: Why do you want to relocate (not enough jobs in your area, great offer, career growth, family, etc.)? 
### 4. Project
...
Databases, Cloud, Apache Spark, ETL, distributed computing, Python etc.
